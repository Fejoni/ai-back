...
/**
 * App\Models\Admin\Post\Subject
 *
 * @property int $id
 * @property string $title
 * @property int $theme_id
 * @method static \Database\Factories\Admin\Post\SubjectFactory factory(...$parameters)
 * @method static \Illuminate\Database\Eloquent\Builder|Subject newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Subject newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Subject query()
 * @method static \Illuminate\Database\Eloquent\Builder|Subject whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Subject whereThemeId($value)
...
namespace App\Models\Admin\Post{
/**
 * App\Models\Admin\Post\Theme
 *
 * @property int $id
 * @property string $title
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Admin\Post\Subject[] $subjects
 * @property-read int|null $subjects_count
 * @method static \Database\Factories\Admin\Post\ThemeFactory factory(...$parameters)
